    ...
    return (
        <Link href={link} className={`${aklass}`} passHref {...props}>
            <motion.button
                ...
                } font-body bg-darkGrey font-regular 2xl:text-base tracking-widest hover-underline-animation z-20 flex items-center justify-center text-primaryColor-50 py-4 text-xs sm:text-base xl:text-sm 3xl:text-[1rem]  sm:py-6 xl:py-4 2xl:py-[0.875rem] 2xl:w-[18rem] px-6 uppercase rounded-[5px]`}
