...
const H1 = ({ children, klasse }) => {
    return (
        <h1
            className={`text-[clamp(32px,calc(32px+0.0957*(100vw-320px)),48px)] uppercase  !leading-[0.95] 3xl:tracking-tight text-balance md:text-5xl lg:text-5xl xl:text-6xl 2xl:text-[6.75rem] mb-4 lg:mb-6  font-headline text-darkGrey ${klasse}`}
        >
            {children}
        </h1>
    );
